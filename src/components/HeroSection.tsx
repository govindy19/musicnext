    ...
    overflow-hidden mx-auto py-10 md:py-0'>
      ...
      />
        ...
        <div className=' p-4 relative z-10 w-full text-center'>
            ...
            <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Dive into a world of creativity and expression and transform your musical journey today.
                Join our community of passionate musicians and unlock your full potential.
